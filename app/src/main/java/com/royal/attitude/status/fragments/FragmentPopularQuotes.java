...
public class FragmentPopularQuotes extends Fragment {
    ...
    public FragmentPopularQuotes newInstance(int pos) {
        FragmentPopularQuotes fragment = new FragmentPopularQuotes();
        ...
        if (position == 0) {
            ...
            lLayout.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    return (adapterImageQuotes.getItemViewType(position) >= 1000 || adapterImageQuotes.isHeader(position)) ? lLayout.getSpanCount() : 2;
                }
            });
    ...
    private void loadTopLikedQuotes() {
        if (methods.isConnectingToInternet()) {
            RequestBody requestBody;
            if (position == 0) {
                requestBody = methods.getAPIRequest(Constants.METHOD_QUOTES_POPULAR_IMAGE, page, "", "", "", "", "", "", "", "", "", "", "", "", "", Constants.itemUser.getId(), "", null);
            } else {
                requestBody = methods.getAPIRequest(Constants.METHOD_QUOTES_POPULAR_TEXT, page, "", "", "", "", "", "", "", "", "", "", "", "", "", Constants.itemUser.getId(), "", null);
            }
