...
public class FragmentFavQuotes extends Fragment {
    ...
    public FragmentFavQuotes newInstance(int pos) {
        FragmentFavQuotes fragment = new FragmentFavQuotes();
    ...
    private void loadFavQuotes() {
        if (methods.isConnectingToInternet()) {
            ...
            if (position == 0) {
                requestBody = methods.getAPIRequest(Constants.METHOD_QUOTES_FAVOURITE, page, "", "", "", "", "image", "", "", "", "", "", "", "", "", Constants.itemUser.getId(), "", null);
            } else {
                requestBody = methods.getAPIRequest(Constants.METHOD_QUOTES_FAVOURITE, page, "", "", "", "", "text", "", "", "", "", "", "", "", "", Constants.itemUser.getId(), "", null);
            }
