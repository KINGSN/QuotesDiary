...
public class LoginActivity extends AppCompatActivity {
    ...
    MaterialButton btn_login_google, btn_login_fb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharePref.getIsRemember() && sharePref.getLoginType().equals(Constants.LOGIN_TYPE_NORMAL)) {
            editText_email.setText(sharePref.getEmail());
            editText_password.setText(sharePref.getPassword());
        }
    }
    ...
    private void loadLogin() {
            ...
            public void onEnd(String success, String loginSuccess, String message, String user_id, String user_name) {
                ...
                if (success.equals("1")) {
                    if (loginSuccess.equals("1")) {
                        Constants.itemUser = new ItemUser(user_id, user_name, editText_email.getText().toString(), "", "", "", Constants.LOGIN_TYPE_NORMAL);
                        if (cb_rememberme.isChecked()) {
                            sharePref.setLoginDetails(Constants.itemUser, true, editText_password.getText().toString(), Constants.LOGIN_TYPE_NORMAL);
                        } else {
                            sharePref.setRemeber(false);
                        }
                        sharePref.setIsAutoLogin(true);
        ...
        }, methods.getAPIRequest(Constants.METHOD_LOGIN, 0, "", "", "", "", Constants.LOGIN_TYPE_NORMAL, "", "", "", "", editText_email.getText().toString(), editText_password.getText().toString(), "", "", "", "", null));
        loadLogin.execute();
    }
    ...
    private void loadLoginSocial(String loginType, String name, String email, String authId) {
        if (methods.isConnectingToInternet()) {
                ...
                public void onEnd(String success, String registerSuccess, String message, String user_id) {
                    ...
                    if (success.equals("1")) {
                        switch (registerSuccess) {
                            case "1":
                                Constants.itemUser = new ItemUser(user_id, name, email, "", "", authId, loginType);
                                sharePref.setLoginDetails(Constants.itemUser, true, "", loginType);
                                sharePref.setIsAutoLogin(true);
                                Constants.isLogged = true;
                                methods.showToast(getString(R.string.login_success));
            ...
            }, methods.getAPIRequest(Constants.METHOD_REGISTER, 0, "", "", "", "", loginType, "", "", "", "", email, "", name, "", authId, "", null));
                ...
                currentAccessToken, new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        try {
                            ...
                            loadLoginSocial(Constants.LOGIN_TYPE_FB, first_name + " " + last_name, email, id);
