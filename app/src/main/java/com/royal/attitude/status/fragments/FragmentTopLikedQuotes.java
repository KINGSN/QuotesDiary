...
public class FragmentTopLikedQuotes extends Fragment {
    ...
    public FragmentTopLikedQuotes newInstance(int pos) {
        FragmentTopLikedQuotes fragment = new FragmentTopLikedQuotes();
    ...
    private void loadTopLikedQuotes() {
        if (methods.isConnectingToInternet()) {
            ...
            if (position == 0) {
                requestBody = methods.getAPIRequest(Constants.METHOD_QUOTES_TOP_LIKE_IMAGE, page, "", "", "", "", "", "", "", "", "", "", "", "", "", Constants.itemUser.getId(), "", null);
            } else {
                requestBody = methods.getAPIRequest(Constants.METHOD_QUOTES_TOP_LIKE_TEXT, page, "", "", "", "", "", "", "", "", "", "", "", "", "", Constants.itemUser.getId(), "", null);
            }
